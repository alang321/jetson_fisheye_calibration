...
parser.add_argument("--capture-width", type=int, default=3280, help="Capture width")
parser.add_argument("--capture-height", type=int, default=2464, help="Capture height")
